...
router.get('/profile', isAuth, profileController.getPRofile.bind(profileController));

router.put('/profile', isAuth, profileController.updateProfile.bind(profileController));

router.delete('/profile', isAuth, profileController.deleteProfile.bind(profileController));

router.put('/profile/picture', isAuth, profileController.updateProfilePicture.bind(profileController));

router.patch('/profile/change-password',isAuth,  profileController.changePassword.bind(profileController));
