...
container
  .bind<IProfileService>(INTERFACE_TYPE.ProfileService)
  .to(ProfileService);

container
  .bind<ProfileController>(INTERFACE_TYPE.ProfileController)
...
// allow use this route to acess only if user is authenticated
